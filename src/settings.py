...
MEAN_PROFILE_LINE_WIDTH = None      # None = the system's series weight, 1.5 pt
MEAN_PROFILE_LINE_COLOR = None      # None = the system's series-1 brand blue
SELECTED_PROFILE_LINE_WIDTH = None  # None = the system's selected weight, 1.75 pt
...
EXCLUDED_REGIONS_ENABLED_DEFAULT = False
EXCLUDED_REGIONS_DEFAULT = ""
EXCLUDED_REGIONS_MODE_NONE = "none"
EXCLUDED_REGIONS_MODE_RELATIVE = "relative"
EXCLUDED_REGIONS_MODE_ABSOLUTE = "absolute"
EXCLUDED_REGIONS_MODE_DEFAULT = EXCLUDED_REGIONS_MODE_NONE
DISTANCE_HIGHLIGHT_REGIONS_DEFAULT = []
HARDNESS_HIGHLIGHT_REGIONS_DEFAULT = []
Y_LIM_LOW_OVERRIDE_DEFAULT = None
Y_LIM_HIGH_OVERRIDE_DEFAULT = None
Y_AXIS_SCALING_START_AT_ZERO = "start_at_zero"
Y_AXIS_SCALING_FIT_TO_DATA = "fit_to_data"
Y_AXIS_SCALING_DEFAULT = Y_AXIS_SCALING_START_AT_ZERO

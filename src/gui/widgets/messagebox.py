...
def show_error_msgbox(text: str, title: str = "Error", buttons: QMessageBox.StandardButton = QMessageBox.StandardButton.Ok):
    show_message_box(text, title, QMessageBox.Icon.Critical, buttons)

def show_warn_msgbox(text: str, title: str = "Warning", buttons: QMessageBox.StandardButton = QMessageBox.StandardButton.Ok):
